...
namespace Nop.Services.ChuyenPhatNhanh
{
    public partial interface IPhieuChuyenPhatService
    {
        ...
        List<PhieuChuyenPhat> GetAllPhieuChuyenPhatTrongThang(int NhaXeId, int vanphonggui_id = 0, DateTime? NgayNhanHang = null,  int VanPhongNhanId = 0, int TuyenId = 0);
        ...
        List<PhieuNhanTIen> GetAllPhieuChuyenTien(int vanphonggui_id = 0, DateTime? NgayNhanTien = null, ENTrangThaiChuyenTien TrangThaiId = ENTrangThaiChuyenTien.ALL, int VanPhongNhanId = 0, DateTime? TuNgay = null, DateTime? DenNgay = null);
        List<PhieuNhanTIen> GetAllPhieuChuyenTien(int vanphonggui_id = 0, DateTime? NgayNhanTien = null, int VanPhongNhanId = 0, ENTrangThaiChuyenTien TrangThaiId = ENTrangThaiChuyenTien.ALL);
        List<PhieuNhanTIen> GetAllPhieuChuyenTienTonTrongNgay(int vanphonggui_id = 0, DateTime? NgayNhanTien = null, int VanPhongNhanId = 0,DateTime? TuNgay=null,DateTime? DenNgay=null);
        List<PhieuNhanTIen> GetAllPhieuChuyenTienTonTrongThang(int vanphonggui_id = 0,  int VanPhongNhanId = 0, int Thang=0,int Nam=0,DateTime? TuNgay=null,DateTime? DenNgay=null);
        List<PhieuNhanTIen> GetAllPhieuNhanTienTrongThang(int vanphonggui_id = 0, DateTime? NgayNhanHang = null, string _thongtin = "", int VanPhongNhanId = 0, DateTime? TuNgay = null, DateTime? DenNgay = null, int Thang = 0, int Nam = 0, DateTime? NgayKetThuc = null,bool isGDNhan=true);
        IList<PhieuNhanTIen> GetPhieuChuyenTiensByIds(int[] PhieuGuiTienIds);
        PhieuNhanTIen GetPhieuNhanTienById(int Id);
        void InsertPhieuNhanTien(PhieuNhanTIen _item);
        void UpdatePhieuNhanTien(PhieuNhanTIen _item);
        void DeletePhieuNhanTien(PhieuNhanTIen _item);
        void InsertPhieuChuyenTienLog(string GhiChu, int PhieuChuyenTienId);
        #endregion
        #region quan ly luan chuyen tien
        List<LuanChuyenTien> GetAllLuanChuyenTien(int vanphonggui_id = 0, DateTime? NgayChuyenTien = null, ENTrangThaiLuanChuyenTien TrangThaiId = ENTrangThaiLuanChuyenTien.All, int VanPhongNhanId = 0, DateTime? TuNgay = null, DateTime? DenNgay = null);
        List<LuanChuyenTien> GetAllLuanChuyenTienTrongThang(int vanphonggui_id = 0, DateTime? NgayChuyenTien = null, string _thongtin = "", int VanPhongNhanId = 0, DateTime? TuNgay = null, DateTime? DenNgay = null, int Thang = 0, int Nam = 0, DateTime? NgayKetThuc = null);
        IList<LuanChuyenTien> GetLuanChuyenTiensByIds(int[] LuanChuyenTienIds);
        LuanChuyenTien GetLuanChuyenTienById(int Id);
        void InsertLuanChuyenTien(LuanChuyenTien _item);
        void UpdateLuanChuyenTien(LuanChuyenTien _item);
        void DeleteLuanChuyenTien(LuanChuyenTien _item);
        void InsertLuanChuyenTienLog(string GhiChu, int LuanChuyenTienId);
        #endregion
        #region quan ly tien trong ket
        List<TienTrongKet> GetAllTienTrongKet(int VanPhongId = 0, DateTime? NgayTao = null, DateTime? TuNgay = null, DateTime? DenNgay = null);
        TienTrongKet GetTienTrongKetById(int Id);
        void InsertTienTrongKet(TienTrongKet _item);
        void UpdateTienTrongKet(TienTrongKet _item);
        void DeleteTienTrongKet(TienTrongKet _item);
        void InsertTienTrongKetLog(string GhiChu, int TienTrongKetId,int PhieuNhanTienId,int LuanChuyenTienId,decimal TienVon,decimal TienCuoc,decimal SoTien,decimal CuocPhi);
        List<TienTrongKetLog> GetTienTrongKetLog(int TienTrongKetId, int PhieuNhanTienId,int LuanChuyenTienId);
        #endregion
    }
}
