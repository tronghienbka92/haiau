...
namespace Nop.Web.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static LuanChuyenTienModel ToModel(this LuanChuyenTien nvfrom,ILocalizationService localizationService, IPriceFormatter priceFormatter)
        {
            var nvto = new LuanChuyenTienModel();
            nvto.Id = nvfrom.Id;
            //van phong gui
            ...
            nvto.NhanVienNhanId = nvfrom.NhanVienNhanId;
        ...
        public static TienTrongKetModel ToModel(this TienTrongKet nvfrom, ILocalizationService localizationService, IPriceFormatter priceFormatter)
        {
            var nvto = new TienTrongKetModel();
            nvto.Id = nvfrom.Id;
            //van phong gui
            nvto.VanPhongId = nvfrom.VanPhongId;
            nvto.TenVanPhong = nvfrom.vanphong != null ? nvfrom.vanphong.TenVanPhong : "";

            nvto.NhanVienId = nvfrom.NhanVienId;
            nvto.SoTien = nvfrom.SoTien;
            nvto.SoTienDauCa = nvfrom.SoTienDauCa;
            nvto.TienCuoc = nvfrom.TienCuoc;
            nvto.NgayTao = nvfrom.NgayTao;
            nvto.GhiChu = nvfrom.GhiChu;
            return nvto;
        }
        public static PhieuNhanTienModel ToModel(this PhieuNhanTIen nvfrom,ILocalizationService localizationService, IPriceFormatter priceFormatter)
        {
            var nvto = new PhieuNhanTienModel();
            nvto.Id = nvfrom.Id;
            nvto.MaPhieu = nvfrom.MaPhieu;
            //van phong gui
            nvto.VanPhongGuiId = nvfrom.VanPhongGuiId;
            ...
            nvto.NgayTao = nvfrom.NgayTao;
            nvto.NgayNhanTien = nvfrom.NgayNhanTien;
            nvto.NgayTraTien = nvfrom.NgayTraTien;
            nvto.GhiChu = nvfrom.GhiChu;
            nvto.TrangThaiId = nvfrom.TrangThaiId;
            ...
            //nhan vien nhan tien
            nvto.NhanVienNhanTienId = nvfrom.NhanVienNhanTienId;
            nvto.NVGiaoDichText = nvfrom.NVGiaoDich != null ? nvfrom.NVGiaoDich.HoVaTen : "";
            //nhan vien tra tien
            nvto.NhanVienTraTienId = nvfrom.NhanVienTraTienId;
            nvto.NVTraTienText = nvfrom.NVTraTien != null ? nvfrom.NVTraTien.HoVaTen : "";
            return nvto;
        ...
        public static PhieuChuyenPhatModel ToModel(this PhieuChuyenPhat nvfrom, ILocalizationService localizationService, IPriceFormatter priceFormatter)
        {
            ...
            //nguoi gui
            nvto.NguoiGuiId = nvfrom.NguoiGuiId;
            nvto.NguoiGuiText =nvfrom.NguoiGui != null ? nvfrom.NguoiGui.toText():"";
            nvto.NguoiGui = nvfrom.NguoiGui;
            //nguoi nhan
            nvto.NguoiNhanId = nvfrom.NguoiNhanId;
            nvto.NguoiNhanText =nvfrom.NguoiNhan !=null ? nvfrom.NguoiNhan.toText() : "";
            nvto.NguoiNhan = nvfrom.NguoiNhan;
