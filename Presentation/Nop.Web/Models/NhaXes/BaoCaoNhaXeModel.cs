...
namespace Nop.Web.Models.NhaXes
{
    ...
    public class BaoCaoNhaXeModel : BaseNopEntityModel
    {
        public enum EN_LOAI_BAO_CAO
        {
            ...
            BAO_CAO_SMS_GUI=13,
            BAO_CAO_CHUYEN_TIEN_THEO_VAN_PHONG=14,
            BAO_CAO_CHUYEN_TIEN_TONG_HOP=15,
            BAO_CAO_NHAN_TIEN_THEO_VAN_PHONG=16,
            BAO_CAO_TRA_TIEN_THEO_VAN_PHONG = 17
        }
        ...
        public List<VanPhongModel> ListVanPhong { get; set; } 
